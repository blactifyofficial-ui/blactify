        ...
        <div className="fixed inset-0 z-[200] bg-black flex flex-col items-center justify-center animate-in fade-in duration-500">
            <div className="relative w-32 h-32 mb-6">
                <Image
                    ...
                    fill
                    sizes="128px"
                    className="object-contain animate-pulse grayscale"
                    priority
                />
            </div>
            <div className="flex flex-col items-center gap-2">
                <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-zinc-600 animate-pulse">
                    Blactify Studio
                </span>
                <div className="h-[1px] w-12 bg-white/5 animate-pulse" />
                <span className="text-[8px] font-medium uppercase tracking-[0.2em] text-zinc-700">
                    Curating Essentials
                </span>
            </div>
        </div>
...
export default async function ShopPage({
    ...
    return (
        <Suspense fallback={<ShopSkeleton />}>
            <main className="min-h-screen bg-black pb-12 animate-in fade-in duration-700">
                <div className="px-6">
                    <Filters
                    ...
                    <div className="relative min-h-[400px]">
                        {result.products.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-20 text-center">
                                <p className="text-zinc-600">No items found matching your filter.</p>
                            </div>
                        )}
                    </div>
                </div>
