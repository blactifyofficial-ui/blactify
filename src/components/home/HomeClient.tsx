    ...
    return (
        ...
        >
            ...
            {initialCategories.length > 0 && (
                <section className="px-6 pt-24 pb-4 md:pt-32 md:pb-8 bg-black">
                        ...
                        <div className="flex flex-wrap justify-center gap-x-8 gap-y-16 md:gap-x-12 lg:gap-x-16">
                            {initialCategories.map((cat) => (
                                ...
                                >
                                    ...
                                    <span className="text-[11px] font-bold text-zinc-600 uppercase tracking-widest opacity-80 group-hover:opacity-100 transition-opacity whitespace-nowrap overflow-hidden text-ellipsis w-full">
                                        {cat.name}
                                    </span>
                                </Link>
                            ))}
            ...
            <section className="px-6 py-12 md:py-20 bg-black">
                <div className="mx-auto max-w-4xl">
                    <Link href="/shop" className="block relative aspect-[3/4] md:aspect-[4/5] w-full group overflow-hidden cursor-pointer">
                        <Image
                            src="/man.png"
                            alt="Blactify Studio Collection"
                            fill
