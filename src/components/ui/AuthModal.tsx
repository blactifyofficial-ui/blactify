...
import { X, Mail, Lock, User, ArrowRight, Eye, EyeOff, RotateCcw } from "lucide-react";
...
import { sendSignupOTP, verifySignupOTP, sendPasswordReset } from "@/actions/auth";
...
export function AuthModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Basic Email Validation for all modes
        ...
        // Zod Validations for signup/signin
            ...
            >
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 font-sans">
                        ...
                        >
                            {loading ? "Processing..." : mode === "signin" ? "Login" : mode === "forgot" ? "Send Link" : step === "details" ? "Join Now" : "Verify & Join"}
                            {!loading && (mode === "forgot" ? <RotateCcw size={16} /> : <ArrowRight size={16} />)}
                        </button>
